...
function Setup-Azure {
    ...
    # under certain combinations of runner image and cli version. To avoid this it seems to help by 
    # calling the command command using --help seems to allow it to load under a diffent path that
    # is not impacted with the same deadlock issues.
